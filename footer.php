			...
			<div class="row">
				...
				<div class="col-lg-2 col-md-6 col-sm-6">
					<div class="footer-item">
						<h4>useful links</h4>
						<ul class="links">
							<li><a href="apartment.php"><i class="fa fa-angle-right"></i>Property</a></li>
							<li><a href="buy.php"><i class="fa fa-angle-right"></i>Service</a></li>
							<li><a href="rent.php"><i class="fa fa-angle-right"></i>Sell/Rent</a></li>
							<li><a href="agent.php"><i class="fa fa-angle-right"></i>Agent</a></li>
